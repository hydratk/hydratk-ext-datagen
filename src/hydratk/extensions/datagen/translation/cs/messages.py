...
.. module:: hydratk.extensions.datagen.translation.cs
   :platform: Unix
   :synopsis: Czech language translation for Datagen extension
...
msg = {
    ...
    'datagen_asn1_decoded': ["Dekódováno do výstupního souboru: '{0}'"],
    'datagen_asn1_encode': ["Enkóduji vstupní soubor: '{0}' do formátu: '{1}' podle elementu: '{2}' specifikace: '{3}'"],
    'datagen_asn1_encoded': ["Enkódováno do výstupního souboru: '{0}'"],
    'datagen_asn1_transcode': ["Transkóduji vstupní soubor: '{0}' z formátu: '{1}' do formátu: '{2}' podle elementu: '{3}' specifikace: '{4}'"],
    ...
    'datagen_adapter_parsing_test': ["Parsuji test"],
